...
const getDataRequestActionCreator = createActionCreator(GET_ARTICLE.REQUEST, PAYLOAD);
const getDataSuccessActionCreator = createActionCreator(GET_ARTICLE.SUCCESS, PAYLOAD);
